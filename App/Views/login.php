    ...
    <div class="border-2 rounded px-12 py-10 bg-white border-black">
      <div class=" items-center">
        ...
        <div class="flex flex-col gap-3 mb-5">
          ...
          <div>
            <input class="text-lg bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none" type="password" name="pass" placeholder="Password">
          </div>
        </div>
