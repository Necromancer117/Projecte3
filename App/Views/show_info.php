...
<body>
    ...
    <div class="bg-black text-center py-5">
        <p class="font-extrabold text-amber-200 text-5xl underline"><?php echo ($show['nombre_espectaculo']) ?></p>
    </div>
    <div class="grid grid-cols-1 lg:grid-cols-2 container mx-auto my-12">

        <div class="border-r-2 border-black">
            <img class="w-[400px] mx-auto" src="../img/shows/<?php echo ($show['imagen_espectaculo']) ?>" alt="" srcset="">
        </div>
        <div class="flex text-center">
            <div class="mx-32 my-auto">
                <p><?php echo($show['descripcion_espectaculo']) ?></p>
            </div>
        </div>
    </div>
    <div class="bg-black text-center py-5">
